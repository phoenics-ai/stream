...
def _node(op_type, n_in, n_out):
    """A minimal duck-typed stand-in for a ComputationNode."""
    return SimpleNamespace(type=op_type, inputs=[None] * n_in, outputs=[None] * n_out)
